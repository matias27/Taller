...
public class Casa 
{
	...
	public Casa(String pathIn, String pathOut) throws FileNotFoundException, IOException
	{
		...
		System.out.println(this.frente + "  " + this.prof + " " + this.xInic + "   " + this.yInic + "   " + this.orientacion);
